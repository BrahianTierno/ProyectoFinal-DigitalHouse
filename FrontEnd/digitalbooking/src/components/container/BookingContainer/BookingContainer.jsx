...
const BookingContainer = () => {
    ...
    axios.get(`http://localhost:8080/reservas/productos/${selectedData?.id}`)
    ...
    return (
            ...
            <section className={styles.sectionContainer}>            
              <div className={styles.topContainer}>
                    <section >
                        <h6 className={styles.category}>Hotel</h6>
                        <h3 className={styles.nameHotel}>Hermitage Hotel</h3>
                    </section>                    
                    <Link to="/home"><MdOutlineArrowBackIos style={{fontSize:"40px" , color:"white" , marginTop:"17px" , marginRight:"30px"}} /></Link>                    
                </div>
                <div className={styles.middleContainer}>
                    <div className={styles.middleLeft}>
                        ...
                        <Calendar clase={"oneCalendarBooking"} clase2={"calendarBooking"} handleBookingDate={handleDateRangeBooking} disableDates={disableDates}/>
                        <h4 className={styles.title}>Tu horario de llegada</h4>
                        <SelectCheckin/>
                    </div>
                    <div className={styles.middleRigth}>
                        <CardBooking dataProductos={selectedData} startDate={convertirFecha(date1)} endDate={convertirFecha(date2)}/>
                    </div>                  
                </div>                
                </section>
