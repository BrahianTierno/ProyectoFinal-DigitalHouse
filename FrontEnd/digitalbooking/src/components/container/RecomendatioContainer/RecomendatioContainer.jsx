  ...
  return (
    <div className={styles.container}>
      ...
      <section className={styles.sectionContainer}>
        {products.map((data) =>{
          return <RecomendationCard key={data.id} id={data.id} img={data.imagenes} title={data.nombre} calification={data.calificacion} category={data.categoria} desciption={data.descripcion} direction={"A 90 metros del centro"} review={data.valoracion}/>
        })}
